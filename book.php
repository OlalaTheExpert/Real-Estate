        ...
        <div class="products1" style="height:110vh;">
          ...
          <div class="form-group col-sm-12">
           <div class="item">
                  ...
                  <input id="card-holder" type="text" class="form-control" placeholder="Olala" name="fname" style="height:45px;" required>
            </div>
      </div>
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="input-group expiration-date">
                    <input type="text" class="form-control" placeholder="Victor" name="lname" style="height:45px;" required>
            </div>
          </div>
                 ...
                 <div class="form-group col-sm-12">
                  ...
                  <div class="input-group expiration-date" >
                    <input type="email" class="form-control" placeholder="olalavictor@gmail.com" name="phone" style="height:45px;" required>
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="input-group expiration-date" >
                    <input type="number" class="form-control" placeholder="2547******60" name="phone" style="height:45px;" required>
