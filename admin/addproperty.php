		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					...
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add New Property</h4>
                    ...
                    <div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="House_type" required>
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="hire_cost" required>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
