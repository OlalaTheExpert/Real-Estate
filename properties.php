...
<head>
    <title>CYTONN ESTATE PROPERTIES</title>
    <!-- for-mobile-apps -->
...
<body>
    ...
    <div class="banner-top">
        ...
        <div class="contact-bnr-w3-agile">
            <ul>
                <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@mountainhighski.com">info@carerental.com</a></li>
                <li><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:+254797814432">254-707-672504</a></li>
        ...
        <div class="container">
            <nav class="navbar navbar-default">
                <div class="navbar-header navbar-left">
                    ...
                    <h1><a class="navbar-brand" href="index.php" style=" margin-left: 0rem;">CYTONN <span>ESTATES</span>
							<p class="logo_w3l_agile_caption">Your Dreamy Home</p>
						</a></h1>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <nav class="menu menu--iris">
                        <ul class="nav navbar-nav menu__list">
                            ...
                            <li class="menu__item"><a href="system/properties.php" class="menu__link">Properties</a></li>

                            <li class="menu__item">
                                <a href="#rooms" class="menu__link scroll">CLIENTS</a>
                            </li>
                            <li class="menu__item">
                                <a href="#rooms" class="menu__link scroll">LANDLORDS</a>
                            </li>
    ...
    <div id="home" class="w3ls-banner">
        <!-- banner-text -->
          ...
          <h3 class="title-w3-agileits title-black-wthree ">Some of our Properties</h3>
...
<div class="col-md-4 price-grid ">                
                    <div class="price-block agile ">
                        <div class="price-gd-top ">
                            <a href="#">
						<img class="thumb" src="system/house_images/<?php echo $rws['image'];?>">
					</a>
